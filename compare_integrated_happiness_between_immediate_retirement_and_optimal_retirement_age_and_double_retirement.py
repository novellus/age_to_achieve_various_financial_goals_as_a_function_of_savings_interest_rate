...
if __name__ == '__main__':
    ...
    descriptor = (f'Integrated happiness over lifetime and death age as a function of savings interest rate and retirement age. (evaluated at discrete 1-year intervals)\n' +
                  f'Comparing retirement strategies: immediate retirement, optimal retirement age (maximizes integrated happiness), and immediate retirement + run out of money + work again + optimal 2nd retirement (maximizes integrated happiness). These regions are identical except for a small window near the middle.\n' +
