...
if __name__ == '__main__':
    ...
    # plot setup
    descriptor = (f'Intrgrated happiness over lifetime as a function of age of retirement and annual interest rate. (evaluated at 1-year intervals)\n' + 
    ...
    plt.ylabel('integrated happiness')
